...
function findWasmBinary() {
    return locateFile('my_target.wasm');
}
...
var ASM_CONSTS = {
  98024: () => { if (document.fullscreenElement) return 1; },  
 98070: () => { return document.getElementById('canvas').width; },  
 98122: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98190: () => { document.exitFullscreen(); },  
 98217: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 98290: () => { if (document.fullscreenElement) return 1; },  
 98336: () => { return document.getElementById('canvas').width; },  
 98388: () => { return screen.width; },  
 98413: () => { document.exitFullscreen(); },  
 98440: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98573: () => { return window.innerWidth; },  
 98599: () => { return window.innerHeight; },  
 98626: () => { if (document.fullscreenElement) return 1; },  
 98672: () => { return document.getElementById('canvas').width; },  
 98724: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98792: () => { if (document.fullscreenElement) return 1; },  
 98838: () => { return document.getElementById('canvas').width; },  
 98890: () => { return screen.width; },  
 98915: () => { return window.innerWidth; },  
 98941: () => { return window.innerHeight; },  
 98968: () => { if (document.fullscreenElement) return 1; },  
 99014: () => { return document.getElementById('canvas').width; },  
 99066: () => { return screen.width; },  
 99091: () => { document.exitFullscreen(); },  
 99118: () => { if (document.fullscreenElement) return 1; },  
 99164: () => { return document.getElementById('canvas').width; },  
 99216: () => { return parseInt(document.getElementById('canvas').style.width); },  
 99284: () => { document.exitFullscreen(); },  
 99311: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 99369: () => { return screen.width; },  
 99394: () => { return screen.height; },  
 99420: () => { return window.screenX; },  
 99447: () => { return window.screenY; },  
 99474: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99527: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 99598: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 99655: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99911: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 99982: () => { if (document.fullscreenElement) return 1; },  
 100028: () => { return window.innerWidth; },  
 100054: () => { return window.innerHeight; },  
 100081: () => { if (document.pointerLockElement) return 1; }
};
